...
const Pricing = () => {
  const handleWhatsApp = (planName, planPrice) => {
    const phone = "6283822757990";
    const message = encodeURIComponent(
      `Halo Kak! 👋

Saya tertarik dengan *Paket ${planName}* senilai *Rp ${planPrice}* yang saya lihat di website.

Boleh minta info lebih lanjut mengenai:
- Detail layanan yang termasuk dalam paket ini
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex items-end justify-center gap-1">
                  ...
                  <span className="text-4xl lg:text-5xl font-heading font-extrabold text-slate-900">
                    {plan.price}
                  </span>
                </div>
              </div>
